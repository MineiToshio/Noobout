<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Categorias.aspx.cs" Inherits="TuImportas.eShop.PL.Web.administrador.Categorias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContent" runat="server">
    ...
    <div class="span12">
        <div class="underlined push-down-30">
            <h3><span class="light">Administrar</span> Categorías</h3>
        </div>
        <center>
            <asp:GridView ID="gvCategorias" runat="server"
                ...
                ShowHeader="true" OnRowCommand="gvCategorias_RowCommand">
                <EmptyDataTemplate>
                    <center><asp:Label ID="lMensajes" runat="server" Font-Size="9pt" ForeColor="#00639E" Text="[No se encontraron categorías]"></asp:Label></center>
                </EmptyDataTemplate>
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Editar" ShowHeader="False" ItemStyle-HorizontalAlign="Center">
                        ...
                        <EditItemTemplate>
                            <asp:LinkButton ID="lnkActualizar" runat="server" CausesValidation="True" CommandName="Actualizar" CommandArgument='<%# Eval("Id_Categoria")%>' Text="Actualizar"  ValidationGroup="vgActualizar" OnClientClick="if(Page_ClientValidate('vgActualizar')){ Loading() }"></asp:LinkButton>
