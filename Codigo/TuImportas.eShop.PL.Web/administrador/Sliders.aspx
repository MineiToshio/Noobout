...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContent" runat="server">
    <div class="content_admin">
        ...
        <center>
            <table>
                <tr>
                    <td align="left"><asp:Button runat="server" ID="btnActualizarOrden" Text="Actualizar Orden" CssClass="btn btn-dark higher bold" OnClick="btnActualizarOrden_Click"/></td>
                </tr>
                <tr>
                    <td>
