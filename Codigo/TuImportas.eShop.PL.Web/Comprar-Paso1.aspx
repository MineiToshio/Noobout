...
<asp:Content ID="Content3" ContentPlaceHolderID="FooterContent" runat="server">
    <script type="text/javascript">
        ...
        function RemoverShopCarrito(idProducto)
        {
            $.ajax
            ({
                type: "POST",
                ...
                success: function (response) {
                    $("#trItemCarrito" + idProducto).remove();
        ...
        function CalcularSubtotal()
        {
            ...
            $('input[name^=inputCantidad]').each(function () {
                ...
                subtotal += $('#inputCantidad' + id).val() * $('#spanPrecio' + id).text();
            });
        ...
        function Continuar()
        {
            if ($("#<%=bodyCarrito.ClientID%>").validationEngine('validate')) {
                ...
                ({
                    ...
                    data: "{'lstColor': '" + lstColor + "', 'lstCantidad': '" + lstCantidad + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
                        if (response.d == 1) {
