...
var WebMarketVars = {
    ...
    currencySymbol: "S/. ",
    priceRange: [ 0, 3000 ], // minimum and maximum range for the price range selector
    priceStep: 50
};
...
jQuery(document).ready(function($) {
    ...
    $("#panelNuevos").click(function () {
        var $this = $(this);
        $("html, body").animate({
            scrollTop: $("#divNuevos").offset().top - 40
        }, 700, "easeInOutQuart");
        return false;
    });
    $("#panelPromociones").click(function () {
        var $this = $(this);
        $("html, body").animate({
            scrollTop: $("#divDestacados").offset().top - 30
        }, 700, "easeInOutQuart");
        return false;
    });
    //  ========== 
